    ...
    <div>
        <div>
            <div style="margin-bottom: 15px;">
                <el-input v-model="params.title" style="width: 200px;" placeholder="请输入公告标题"
                    @change="findBySearch()"></el-input>
                <el-input v-model="params.content" style="width: 200px;margin-left: 5px;" placeholder="请输入公告内容"
                    @change="findBySearch()"></el-input>
            ...
            <div>
                <el-table :data="tableData" height="300" border style="width: 100%">
                    ...
                    <el-table-column prop="create_date" label="发起时间">
                    </el-table-column>
        ...
        <div>
            <el-dialog title="编写公告" :visible.sync="dialogFormVisible">
                <el-form :model="form">
